// ============================================================
// RANDOM CHALLENGE HUB — Ukrainian Translation (uk)
// Community translation
// ============================================================

window.RCH_TRANSLATIONS = window.RCH_TRANSLATIONS || {};
window.RCH_TRANSLATIONS['uk'] = {
  _meta: {
    code:        'uk',
    name:        'Ukrainian',
  ...
  'common.live_ready':      'ГОТОВО ДО СТРІМУ',
  'common.add':             '+ Додати',
  ...
  'common.back_to_app':     '← Повернутися до застосунку',
  'common.loading':         'Завантаження інструментів…',
  ...
  'header.tagline':         'Створюй • Грай • Стрім • Перемагай',
  'header.live_badge':      'ГОТОВО ДО СТРІМУ',
  ...
  'feat.themes':            '5 тем і 10 кольорових схем',
  'feat.timer':             'Таймер для стрімера зі зворотним відліком',
  ...
  'info.vote_desc':         'Глядачі обирають завдання',
  'info.subs_label':        'Колесо підписників',
  'info.subs_desc':         'Випадковий вибір серед підписників',
  ...
  'games.no_game_name':     'Введіть назву гри',
  ...
  'players.stats_reset':    'Статистику скинуто',
  'players.delete_confirm': 'Видалити гравця "{name}"?',
  'players.delete_btn':     'ВИДАЛИТИ',
  ...
  'roulette.mode_game_first_desc':'Завдання для всіх',
  'roulette.mode_player_only':'Лише гравець',
  'roulette.mode_player_only_desc':'Вибір учасника',
  'roulette.mode_task_only':'Лише завдання',
  'roulette.mode_task_only_desc':'Гра + Гравець + Завдання',
  'roulette.mode_game_only':'Лише гра',
  'roulette.mode_game_only_desc':'Випадкова гра',

  'roulette.hint_full':      'Випадкова гра + випадкове завдання + випадковий гравець',
  'roulette.hint_game_first':'Спочатку обирається гра, потім завдання для кожного гравця',
  'roulette.hint_player_only':'Колесо обирає лише випадкового гравця зі списку',
  ...
  'roulette.add_tasks':     'Додайте завдання',

  'roulette.no_tasks_game': 'У вибраній грі немає завдань',
  'roulette.select_game':   'Оберіть гру зі списку',
  ...
  'roulette.now_spinning':  'Зараз обертається',
  'roulette.remaining':     'Залишилось: {n}',
  ...
  // ── STREAMER TAB ──────────────────────────────────────────
  'streamer.hero_title':    'РЕЖИМ СТРІМЕРА',
  'streamer.hero_desc':     'Розширені інструменти для стрімів: OBS Overlay, голосування в чаті, таймер, швидкі команди та колесо підписників.',
  ...
  'streamer.vote_desc':     'Глядачі обирають завдання через чат',
  ...
  'streamer.cmd_viewer_title':'Команди глядачів:',
  'streamer.cmd_join':      '!join або !addme — додати себе до колеса',

  'streamer.timer_title':   'ТАЙМЕР СТРІМЕРА',
  'streamer.timer_desc':    'Зворотний відлік для випробувань (команда: !timer N)',
  ...
  'streamer.subwheel_title':'КОЛЕСО ПІДПИСНИКІВ',
  'streamer.subwheel_desc': 'Рулетка глядачів (команди: !join, !addchatters)',
  ...
  'streamer.quick_spin':    'Обернути!',
  'streamer.quick_copy':    'Копіювати результат',
  'streamer.quick_export':  'Експорт',
  'streamer.quick_roulette':'До рулетки',
  'streamer.quick_chat':    'Завдання з чату',
  'streamer.quick_overlay': 'OBS Overlay',
  'streamer.quick_vote':    'Голосування',
  ...
  'streamer.tools_title':   'ІНСТРУМЕНТИ ДЛЯ СТРІМУ',
  'streamer.tools_desc':    'Додаткові можливості для стрімінгу',

  'streamer.sounds_label':  'Звуки чату:',
  'streamer.sounds_hint':   'Сповіщення про повідомлення',
  ...
  'settings.animation':     'Анімація обертання',
  'settings.anim_ease':     'Плавна (ease)',
  'settings.anim_bounce':   'Пружна (bounce)',
  'settings.anim_elastic':  'Еластична (elastic)',
  'settings.anim_linear':   'Лінійна',
  ...
  'settings.win_sound':     'Звук перемоги',

  'settings.spin_sound_type':'Тип звуку обертання',
  'settings.sound_whoosh':  'Свист',
  ...
  'settings.group_segs':    'Групувати сектори',

  'settings.center_icon':   'Іконка в центрі',

  'settings.border_style':  'Стиль рамки',
  'settings.border_glow':   'Світіння',
  'settings.border_solid':  'Суцільна',
  ...
  'settings.shake_effect':  'Тряска після зупинки',
  'settings.glow_effect':   'Світіння колеса',

  'settings.particle_effect':'Частинки перемоги',
  'settings.particle_count':'Кількість частинок',

  'settings.particle_style':'Стиль частинок',
  'settings.particle_circle':'Кола',
  'settings.particle_star': 'Зірки',
  'settings.particle_confetti':'Конфеті',

  'settings.result_display':'Відображення результату',
  'settings.result_both':   'Спливаюче вікно + картка',
  'settings.result_popup':  'Лише спливаюче вікно',
  'settings.result_card':   'Лише картка',

  'settings.auto_close':    'Автоматично закривати вікно',
  ...
  'settings.pos_top_left':  'Вгорі ліворуч',
  'settings.pos_top_right': 'Вгорі праворуч',
  'settings.pos_bot_left':  'Внизу ліворуч',
  'settings.pos_bot_right': 'Внизу праворуч',
  ...
  'settings.theme_cyber':   'Кібер',
  'settings.theme_streamer':'Стрімер',
  'settings.theme_pastel':  'Пастельна',
  ...
  'wheel.add_players':       'Додайте гравців',

  'wheel.no_tasks':          'Немає завдань',
  'wheel.add_tasks':         'Додайте завдання',

  'wheel.select_game':       'Оберіть гру',
  'wheel.select_game_desc':  'Оберіть гру зі списку',
  ...
  'wheel.waiting':           'Очікування результату…',
  ...
  'overlay.timer_waiting':   'очікування',

  'overlay.chat_empty':      'Чат не підключено',
  ...
  'overlay.vote_sec':        '{n} с',
    ...
    // ── LEGAL PAGES ───────────────────────────────────────────
  'legal.nav_privacy':      'Політика конфіденційності',
  'legal.nav_terms':        'Умови використання',
  'legal.nav_disclaimer':   'Відмова від відповідальності',
  'legal.nav_license':      'Ліцензія',
  'legal.nav_about':        'Про проєкт',

  'legal.last_updated':     'Останнє оновлення: {date}',

  'legal.privacy_title':    'Політика конфіденційності',
  'legal.terms_title':      'Умови використання',
  'legal.disclaimer_title': 'Відмова від відповідальності',
  'legal.license_title':    'Ліцензія MIT',
  'legal.about_title':      'Про Random Challenge Hub',

  // ── LEGAL — PRIVACY POLICY ────────────────────────────────
  'legal.privacy_updated':    'Останнє оновлення: 29 липня 2026',
  'legal.privacy_h1':         '1. Вступ',
  'legal.privacy_p1':         'Random Challenge Hub («ми», «наш застосунок») поважає вашу конфіденційність. Ця політика пояснює, як обробляються дані під час використання вебзастосунку.',

  'legal.privacy_h2':         '2. Збір даних',
  'legal.privacy_p2a_strong': 'Локальне зберігання:',
  'legal.privacy_p2a':        'Усі дані (ігри, завдання, список гравців, статистика) зберігаються виключно у localStorage вашого браузера. Ми не збираємо, не передаємо й не зберігаємо дані на зовнішніх серверах.',

  'legal.privacy_p2b_strong': 'Автоматично зібрані дані:',
  'legal.privacy_p2b':        'Ми не використовуємо cookies, трекери чи аналітику. Застосунок повністю працює на стороні клієнта.',

  'legal.privacy_h3':         '3. Використання даних',
  'legal.privacy_p3':         'Введені вами дані використовуються лише для:',

  'legal.privacy_li1':        'роботи рулетки випадкового вибору',
  'legal.privacy_li2':        'відображення статистики',
  'legal.privacy_li3':        'збереження ваших налаштувань між сесіями',

  'legal.privacy_h4':         '4. Передача даних третім особам',
  'legal.privacy_p4':         'Ми не передаємо ваші дані третім особам. Уся інформація залишається на вашому пристрої.',

  'legal.privacy_h5':         '5. Безпека',
  'legal.privacy_p5':         'Дані зберігаються в localStorage браузера. Ви можете будь-коли очистити їх через налаштування браузера або за допомогою функції «Очистити кеш».',

  'legal.privacy_h6':         '6. Ваші права',
  'legal.privacy_p6':         'Ви маєте право:',

  'legal.privacy_li4':        'переглядати всі збережені дані',
  'legal.privacy_li5':        'експортувати дані у форматі JSON',
  'legal.privacy_li6':        'видалити всі дані через функцію скидання',
  'legal.privacy_li7':        'очистити кеш браузера',

  'legal.privacy_h7':         '7. Зміни політики',
  'legal.privacy_p7':         'Ми залишаємо за собою право оновлювати цю політику. Зміни набирають чинності після публікації.',

  // ── LEGAL — TERMS ─────────────────────────────────────────
  'legal.terms_updated':      'Останнє оновлення: 29 липня 2026',

  'legal.terms_h1':           '1. Прийняття умов',
  'legal.terms_p1':           'Використовуючи Random Challenge Hub, ви погоджуєтесь із цими умовами. Якщо ні — не використовуйте застосунок.',

  'legal.terms_h2':           '2. Опис сервісу',
  'legal.terms_p2':           'Random Challenge Hub — це безкоштовний вебзастосунок для створення та випадкового вибору ігрових завдань. Застосунок надається «як є» без будь-яких гарантій.',

  'legal.terms_h3':           '3. Відповідальність користувача',
  'legal.terms_p3':           'Ви несете повну відповідальність за:',

  'legal.terms_li1':          'створені вами ігри та завдання',
  'legal.terms_li2':          'дані, введені в застосунок',
  'legal.terms_li3':          'використання застосунку відповідно до законодавства вашої країни',

  'legal.terms_h4':           '4. Заборонене використання',
  'legal.terms_p4':           'Заборонено використовувати застосунок для:',

  'legal.terms_li4':          'створення образливого чи незаконного контенту',
  'legal.terms_li5':          'порушення прав третіх осіб',
  'legal.terms_li6':          'поширення шкідливого програмного забезпечення',
  'legal.terms_li7':          'будь-якої незаконної діяльності',

  'legal.terms_h5':           '5. Інтелектуальна власність',
  'legal.terms_p5':           'Код застосунку є відкритим. Ви можете використовувати, змінювати та поширювати його відповідно до ліцензії MIT.',

  'legal.terms_h6':           '6. Відмова від гарантій',
  'legal.terms_p6':           'Застосунок надається «як є». Ми не гарантуємо безперебійну роботу, точність результатів або збереження даних.',

  'legal.terms_h7':           '7. Обмеження відповідальності',
  'legal.terms_p7':           'Ми не несемо відповідальності за будь-які збитки, що виникли через використання або неможливість використання застосунку.',

  'legal.terms_h8':           '8. Зміни умов',
  'legal.terms_p8':           'Ми можемо оновлювати ці умови. Продовжуючи користуватися застосунком, ви приймаєте всі зміни.',

  // ── LEGAL — DISCLAIMER ────────────────────────────────────
  'legal.disclaimer_h1':      '1. Ігровий контент',
  'legal.disclaimer_p1':      'Random Challenge Hub генерує випадкові завдання. Ми не несемо відповідальності за контент, створений користувачами.',

  'legal.disclaimer_h2':      '2. Стріми та публічний контент',
  'legal.disclaimer_p2':      'Під час використання застосунку на стрімах або публічних заходах ви самостійно відповідаєте за показаний контент та його відповідність правилам платформ (Twitch, YouTube тощо).',

  'legal.disclaimer_h3':      '3. Ігрові платформи',
  'legal.disclaimer_p3':      'Застосунок не пов’язаний із Minecraft, CS2, Apex Legends чи будь-якими іншими іграми. Усі торговельні марки належать їхнім власникам.',

  'legal.disclaimer_h4':      '4. Технічні обмеження',
  'legal.disclaimer_p4':      'Застосунок використовує localStorage браузера. Очищення кешу призведе до втрати даних. Рекомендуємо регулярно експортувати свої дані.',

  // ── LEGAL — LICENSE ───────────────────────────────────────
  'legal.license_copyright':     'Copyright © 2026 Random Challenge Hub',
  'legal.license_intro':         'Це програмне забезпечення розповсюджується за ліцензією MIT.',
  'legal.license_terms_heading': 'Умови ліцензії:',

  // ── LEGAL — ABOUT ─────────────────────────────────────────
  'legal.about_h1':          'Історія створення',
  'legal.about_p1':          'Random Challenge Hub був створений, щоб вирішити проблему «у що пограти та як урізноманітнити геймплей». Ідея виникла через потребу стрімерів і гравців у чесному випадковому виборі завдань.',

  'legal.about_h2':          'Технології',
  'legal.about_p2':          'Застосунок створений на чистих вебтехнологіях:',

  'legal.about_li1':         'HTML5 із семантичною розміткою',
  'legal.about_li2':         'CSS3 із підтримкою темної теми',
  'legal.about_li3':         'Vanilla JavaScript без фреймворків',
  'legal.about_li4':         'Canvas API для анімації колеса',
  'legal.about_li5':         'Web Audio API для звукових ефектів',
  'legal.about_li6':         'LocalStorage для збереження даних',
  ...
  'mobile.subtitle':   'Потрібен комп’ютер',
  'mobile.desc':       '<strong>Random Challenge Hub</strong> — професійний інструмент, створений для роботи на настільних ПК: велике колесо Canvas, багатовіконний режим OBS та повне керування з клавіатури.',

  'mobile.why_title':  'ЧОМУ ПК?',
  'mobile.why_1':      'Колесу Canvas потрібен екран шириною не менше 900 px',
  'mobile.why_2':      'OBS Overlay працює з кількома вікнами',
  'mobile.why_3':      'Панель налаштувань розрахована на клавіатуру',
  'mobile.why_4':      'Twitch IRC найкраще працює на десктопі',

  'mobile.alt_title':      'Що можна зробити?',
  'mobile.alt_pc':         'Відкрити на ПК',
  'mobile.alt_pc_desc':    'Chrome, Firefox, Edge або будь-який сучасний браузер',

  'mobile.alt_tablet':     'Використати планшет',
  'mobile.alt_tablet_desc':'iPad або Android-планшет у горизонтальному режимі',

  'mobile.alt_share':      'Поділитися посиланням',
  ...
  // Він повністю сумісний з українською локалізацією.

  'tips': window.RCH_TRANSLATIONS['en']['tips'],
